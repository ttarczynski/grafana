...
func (p *FileProvider) Read(sid string) (_ session.RawStore, err error) {
...
func (p *FileProvider) Regenerate(oldsid, sid string) (_ session.RawStore, err error) {
...
func init() {
	session.Register("file2", &FileProvider{})
}
